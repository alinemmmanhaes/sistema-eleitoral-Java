...
public class Eleicao {
    ...
    public void relatorio10(){
        ...
        System.out.println("Total de votos nominais:   " + nominal + " (" + brFormat.format(100*((double)nominal)/total) + "%)" );
        System.out.println("Total de votos de legenda: " + legenda + " (" + brFormat.format(100*((double)legenda)/total) + "%)");
        System.out.println();
    }
